...
int main() {
	...
	cout << "Point ID: " << p.ID() << endl; // ID of the point. Does this work? YES IT DOES!
	cout << "Line ID: " << l.ID() << endl; // ID of the line. Does this work? YES IT DOES!
	Shape* sp; // Create pointer to a shape variable.
	sp = &p; // Point in a shape variable. Possible? Yes it is possible!
	cout << sp->ToString() << endl; // What is printed? I got an ID number!
	// Create and copy Point p to new point.
	Point p2;
	p2 = p;
	cout << p2 << ", " << p2.ID() << endl; // Is the ID copied if you do not call
	// the base class assignment in point?  ID is not copied over.
